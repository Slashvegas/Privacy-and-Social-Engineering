...
### 2. What kind of information was there that you had not directly given yourself? 
- 

### 3. In what format did you receive your data and how many pages/bytes of it were there?
- **Format and Size:** 

### 4. What kind of information was there that you had not directly given yourself?
- 

### 5. Did you understand the meaning of the information?
- 

### 6. Do you think that the company collected the least amount of data required to provide the service you needed?
- 

### 7. Were you surprised about something, what?
- 
</details>
...
- **HTTP_ACCEPT HEADERS**
  - Bits of identifying information: 11.67
  - One in x browsers have this value: 3256.33

- **HASH OF CANVAS FINGERPRINT**
  - Bits of identifying information: 10.65
  - One in x browsers have this value: 1601.48

#### Lowest amount:
  
- **DNT HEADER ENABLED?**
  - Bits of identifying information: 0.82
  - One in x browsers have this value: 1.76

- **TOUCH SUPPORT**
  - Bits of identifying information: 0.73
  - One in x browsers have this value: 1.66

### Why does identifiability matter?
In the context of data privacy, identifiability relates to how easily an individual can be distinguished from others based on the information at hand. This matters because of the serious security risks associated with being identified or having information accessed while surfing online.

### What are the pros and cons of being unique vs common?

#### Unique:
- **Pros:**
  - Unique individuals often receive more tailored experiences, as services and products can be customized to their specific preferences and needs.
  
- **Cons:**
  - In the context of data privacy, being highly unique can make individuals more easily identifiable, increasing the risk of privacy breaches and targeted attacks.

#### Common:
- **Pros:**
  - Being common can offer a level of anonymity online, making it more difficult for individuals to be singled out and their data to be exploited.
  
- **Cons:**
  - Individuals with common characteristics may receive a more generic online experience and may not benefit from the same level of personalization as those with unique profiles.
...
### Canvas + WebGL Data
- **Canvas**: 0.35%
  - **Explanation**: The low percentage suggests that the canvas element, when used for drawing graphics, exhibits only minor variations across different browsers and operating systems. It implies that despite some slight differences, the canvas rendering process is relatively consistent, making it hard to use these variations alone for tracking or distinguishing between users.
    
- **WebGL Data**: 1.36%
  - **Explanation**: Similar to canvas data, this slightly higher percentage for WebGL—a web technology that allows for rendering interactive 3D and 2D graphics within any compatible web browser—indicates a bit more variation. This variability is likely due to differences in graphics hardware and how different browsers and operating systems execute WebGL instructions.

### Screen Dimensions
- **Screen width**: 7.75%
- **Screen height**: 5.45%
  - **Explanation**: These percentages are higher compared to Canvas and WebGL data, indicating a greater diversity in the physical dimensions of screens across devices. Screen width and height can vary significantly, especially with the wide range of devices available, from mobile phones to large desktop monitors.
### Available Screen Dimensions
- **Screen available width**: 7.65%
  - **Explanation**: This figure is close to the overall screen width percentage, suggesting that the available width.

- **Screen available height**: 0.06%
  - **Explanation**: The exceptionally low variation here indicates that the available height (the screen height minus operating system or browser interface elements) is very consistent among different users.
